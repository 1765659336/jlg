<template>
	<jlg-grid ref="jlgGrid" class="table-grid--wrapper"> </jlg-grid>
</template>

<script setup lang="ts">
import { I_Table_Grid_Props, useDynamicModal } from 'jlg-table';
import { getCurrentInstance, onMounted, reactive, ref } from 'vue';
import axios from 'axios';
import { VxeGridListeners, VxeGridPropTypes, VxeGridDefines } from 'vxe-table';
